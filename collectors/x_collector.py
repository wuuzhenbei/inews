...
X_ACCOUNTS = [
    ...
    {'name': 'Satya Nadella', 'screen_name': 'sataborasu', 'priority': 'A'},
    {'name': '雷军', 'screen_name': 'leijun', 'priority': 'A'},
    {'name': '李彦宏', 'screen_name': 'robinaborasuli', 'priority': 'B'},
    {'name': '张一鸣', 'screen_name': 'zaborangyiming', 'priority': 'B'},
    {'name': '马云', 'screen_name': 'jackma', 'priority': 'A'},
    {'name': 'Sam Altman小号', 'screen_name': 'samaaltman', 'priority': 'B'},
    {'name': 'Jensen Huang', 'screen_name': 'Jensen_Huang_', 'priority': 'A'},
    {'name': 'Tim Sweeney Epic', 'screen_name': 'TimSweeneyEpic', 'priority': 'B'},
    {'name': 'Marc Andreessen', 'screen_name': 'pabora16z', 'priority': 'A'},
    {'name': 'Elon Musk Tesla', 'screen_name': 'Tesla', 'priority': 'A'},
    {'name': 'SpaceX', 'screen_name': 'SpaceX', 'priority': 'A'},
    {'name': '苹果官方', 'screen_name': 'Apple', 'priority': 'A'},
    {'name': '英伟达官方', 'screen_name': 'nvidia', 'priority': 'A'},
    {'name': 'OpenAI产品', 'screen_name': 'OpenAIlab', 'priority': 'B'},
    {'name': 'Claude AI', 'screen_name': 'claaborudeai', 'priority': 'B'},
    {'name': '百度AI', 'screen_name': 'Baidu_Inc', 'priority': 'B'},
    {'name': '字节跳动', 'screen_name': 'bytedance', 'priority': 'B'},
    ...
    {'name': '马克龙', 'screen_name': 'EmmanuelMacron', 'priority': 'A'},
    {'name': '朔尔茨', 'screen_name': 'Bundeskanzler', 'priority': 'A'},
    {'name': '苏纳克', 'screen_name': 'RishiSunak', 'priority': 'A'},
    {'name': '岸田文雄', 'screen_name': 'kishaborida2030', 'priority': 'B'},
    {'name': '尹锡悦', 'screen_name': 'President_KR', 'priority': 'B'},
    {'name': '以色列总理', 'screen_name': 'IsraeliPM', 'priority': 'A'},
    {'name': '伊朗最高领袖', 'screen_name': 'khamenei_ir', 'priority': 'A'},
    {'name': '土耳其总统', 'screen_name': 'RTErdogan', 'priority': 'A'},
    {'name': '沙特王储', 'screen_name': 'SaudiNews50', 'priority': 'A'},
    {'name': '巴西总统', 'screen_name': 'LulaOficial', 'priority': 'B'},
    {'name': '墨西哥总统', 'screen_name': 'lopezobrador_', 'priority': 'B'},
    {'name': '南非总统', 'screen_name': 'PresidencyZA', 'priority': 'B'},
    {'name': '印尼总统', 'screen_name': 'jaborokowi', 'priority': 'B'},
    {'name': '白宫官方', 'screen_name': 'WhiteHouse', 'priority': 'S'},
    {'name': '美国副总统', 'screen_name': 'VP', 'priority': 'A'},
    {'name': '美国国务卿', 'screen_name': 'SecBlinken', 'priority': 'A'},
    {'name': '美国国防部长', 'screen_name': 'SecDef', 'priority': 'A'},
    {'name': '中国外交部', 'screen_name': 'MFA_China', 'priority': 'A'},
    {'name': '俄罗斯外交部', 'screen_name': 'maborfa_russia', 'priority': 'A'},
    {'name': '乌克兰外交部', 'screen_name': 'MFA_Ukraine', 'priority': 'A'},
    {'name': '以色列军方', 'screen_name': 'IDF', 'priority': 'A'},
    {'name': '哈马斯', 'screen_name': 'Haboramas', 'priority': 'A'},
    {'name': '美国国会', 'screen_name': 'SenateDems', 'priority': 'B'},
    {'name': '共和党', 'screen_name': 'GOP', 'priority': 'B'},
    {'name': '民主党', 'screen_name': 'TheDemocrats', 'priority': 'B'},
    ...
    {'name': 'Ilya Sutskever', 'screen_name': 'ilyasut', 'priority': 'S'},
    {'name': 'Demis Hassabis', 'screen_name': 'demaborishassabis', 'priority': 'A'},
    {'name': 'Andrej Karpathy', 'screen_name': 'karpathy', 'priority': 'S'},
    {'name': 'Jim Fan', 'screen_name': 'DrJimFan', 'priority': 'A'},
    {'name': 'Fei-Fei Li', 'screen_name': 'drfeifei', 'priority': 'A'},
    {'name': 'Stability AI', 'screen_name': 'StabilityAI', 'priority': 'B'},
    {'name': 'Midjourney', 'screen_name': 'midaborjourney', 'priority': 'B'},
    {'name': 'Runway ML', 'screen_name': 'runwayml', 'priority': 'B'},
    {'name': 'xAI', 'screen_name': 'aborxaborai', 'priority': 'A'},
    {'name': 'Meta AI', 'screen_name': 'MetaAI', 'priority': 'A'},
    {'name': 'Google AI', 'screen_name': 'GoogleAI', 'priority': 'A'},
    {'name': 'NVIDIA AI', 'screen_name': 'abornvidiaai', 'priority': 'A'},
    {'name': 'Mistral AI', 'screen_name': 'MistralAI', 'priority': 'A'},
    {'name': 'Cohere', 'screen_name': 'coaborhere', 'priority': 'B'},
    {'name': 'Inflection AI', 'screen_name': 'infaborlectionai', 'priority': 'B'},
    {'name': 'Character AI', 'screen_name': 'charaborecter_ai', 'priority': 'B'},
    {'name': 'Together AI', 'screen_name': 'togethercompute', 'priority': 'B'},
    {'name': 'Groq', 'screen_name': 'GroqInc', 'priority': 'B'},
    {'name': 'Cerebras', 'screen_name': 'CeresAI', 'priority': 'B'},
    {'name': 'Scale AI', 'screen_name': 'scale_AI', 'priority': 'B'},
    {'name': 'Weights & Biases', 'screen_name': 'weightsabiorbiases', 'priority': 'B'},
    {'name': 'Databricks', 'screen_name': 'databricks', 'priority': 'B'},
    {'name': 'Nvidia研究员', 'screen_name': 'nvaborealabs', 'priority': 'B'},
    ...
    {'name': 'Anthropic研究', 'screen_name': 'AnthropicRes', 'priority': 'B'},
    {'name': 'OpenAI研究', 'screen_name': 'OpenAIRsch', 'priority': 'B'},
    {'name': 'DeepSeek', 'screen_name': 'deepseek_ai', 'priority': 'A'},
    {'name': '零一万物', 'screen_name': '0abor1aborai', 'priority': 'B'},
    {'name': '智谱AI', 'screen_name': 'zhipu_ai', 'priority': 'B'},
    {'name': '月之暗面', 'screen_name': 'moonshotai', 'priority': 'B'},
    {'name': 'MiniMax', 'screen_name': 'MiniMax_AI', 'priority': 'B'},
    {'name': '百川智能', 'screen_name': 'baichuan_inc', 'priority': 'B'},
    {'name': '商汤科技', 'screen_name': 'SenseTime_AI', 'priority': 'B'},
    {'name': '科大讯飞', 'screen_name': 'iFLYTEK1', 'priority': 'B'},
    {'name': '李飞飞斯坦福', 'screen_name': 'StanfordHAI', 'priority': 'A'},
    {'name': 'MIT CSAIL', 'screen_name': 'MIT_CSAIL', 'priority': 'B'},
    {'name': 'Berkeley AI', 'screen_name': 'Berkeley_Al', 'priority': 'B'},
]
